...
class DistributorsControllerTest < ActionController::TestCase
  ...
  test "should create distributor" do
    assert_difference('Distributor.count') do
      post :create, distributor: { email: @distributor.email, first_name: @distributor.first_name, last_name: @distributor.last_name, verified_email: @distributor.verified_email }
    end
  ...
  test "should update distributor" do
    patch :update, id: @distributor, distributor: { email: @distributor.email, first_name: @distributor.first_name, last_name: @distributor.last_name, verified_email: @distributor.verified_email }
    assert_redirected_to distributor_path(assigns(:distributor))
  end
